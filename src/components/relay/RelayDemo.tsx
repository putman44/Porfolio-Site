      ...
      <div className="container mx-auto max-w-7xl">
        <div className="mb-12 grid gap-6 lg:grid-cols-[1fr_0.6fr] lg:items-end">
          <div>
            ...
            >
              See one way an inbound inquiry can enter Relay.
            </h2>
          </div>
          <p className="max-w-xl text-lg leading-relaxed text-slate-300">
            This fictional website-form example shows one possible intake
            source. Relay is configured around the agreed lead sources,
            routing, and systems for each business.
          </p>
        </div>
